...
class AnalysisCollectionCommandFactoryTest {
  ...
  @Test
  @DisplayName("생존율 분석에 필요한 공공데이터 수집 명령을 모두 생성한다")
  void createsAllSurvivalCommands() {
    ...
    List<CommercialDataCollectCommand> commands =
        factory.create(
            ...
            new AnalysisCollectionTarget("20262", List.of(first, second)));
  ...
  @Test
  @DisplayName("수익률 분석에는 매출과 점포 데이터 수집 명령만 생성한다")
  void createsOnlyProfitCommands() {
    SmallBusinessCollectionTarget target =
        new SmallBusinessCollectionTarget("9151", "Q", "Q12", "Q12A01");

    List<CommercialDataCollectCommand> commands =
        factory.create(
            AnalysisCollectionType.PROFIT, new AnalysisCollectionTarget("20262", List.of(target)));
    ...
    assertThat(commands)
        ...
        .noneMatch(KosisBusinessSurvivalCollectCommand.class::isInstance)
        .noneMatch(KosisBusinessCountCollectCommand.class::isInstance)
  ...
  void removesDuplicatedSmallBusinessTargets() {
    ...
    List<CommercialDataCollectCommand> commands =
        factory.create(
            ...
            new AnalysisCollectionTarget("20262", List.of(duplicated, duplicated)));
