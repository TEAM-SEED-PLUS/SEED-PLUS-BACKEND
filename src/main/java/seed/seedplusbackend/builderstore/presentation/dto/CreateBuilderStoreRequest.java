...
@Schema(description = "빌더스토어 생성 요청")
public record CreateBuilderStoreRequest(
    ...
    @Schema(description = "업종 ID", example = "1") @NotNull Long industryId,
    @Schema(description = "기준 건물 ID", example = "1") Long baseBuildingId,
    @Schema(description = "빌더스토어명", example = "강남 샐러드 창업안") @NotBlank @Size(max = 150) String name,
