...
public class KosisBusinessSurvivalJdbcRepository implements KosisBusinessSurvivalStorePort {

  private static final String UPSERT_SQL =
      """
      INSERT INTO kosis_business_survival_rates AS current_data (
        ...
        reference_year, survival_rate, source_updated_at,
      ...
      DO UPDATE SET
        ...
        WHERE current_data.organization_id IS DISTINCT FROM EXCLUDED.organization_id
           ...
           OR current_data.survival_rate IS DISTINCT FROM EXCLUDED.survival_rate
  ...
  public void upsertAll(List<KosisBusinessSurvivalRowResult> rows) {
    ...
    jdbcTemplate.batchUpdate(
        ...
        (statement, row) -> {
          ...
          statement.setBigDecimal(index++, row.survivalRate());
